...
This module adds on to the Rectangle class of the 8-rectangle module by adding
a class method that returns a new instance of the class given one value only.
(a square where width == height)
"""
...
class Rectangle(object):
    ...
    def square(cls, size=0):
        """Returns a special instance of the class where height == width
        (a square). This function serves as an alternative constructor.

        The size validation is done by the width setter property, so we
        don't have to worry about it here.

        Args:
            size (int): The size of the square/rectangle.

        Returns:
            (Rectangle): A new instance of the class where height == width
        """
